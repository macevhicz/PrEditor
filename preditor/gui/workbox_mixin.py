...
class WorkboxMixin(object):
    ...
    def __text_line__(self, lineNum):
        """Return the given line of the workbox's text.

        Args:
            lineNum (int): The line number of the line of text to return

        Returns:
            str: The found line of text
        """
