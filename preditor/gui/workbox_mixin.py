...
class WorkboxMixin(object):
    ...
    def __set_file_monitoring_enabled__(self, state):
        ...
        # monitoring
        self.window().setFileWatchingEnabled(self._filename, state)
        self._fileMonitoringActive = state
    ...
    def __save_prefs__(self, current=None):
        ret = {}
        ...
        if self.__is_dirty__() or not backup_exists:
