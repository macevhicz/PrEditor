...
class CodeHighlighter(QSyntaxHighlighter):
    ...
    def initHighlightVariables(self):
        """Initiale the variables which will be used in code highlighting"""
    ...
    def defineHighlightVariables(self):
        """Define the formats and regex patterns which will be used to highlight code."""
    ...
    def highlightText(self, text, expr, format, offset=0, includeLast=False):
        ...
        while pos != -1:
            ...
            # If this highlight is not blocked, set the formatting
            if not blocked:
                self.setFormat(pos, length, format)
                # Determine the current span and append to self.spans
                curSpan = (pos, pos + length)
                self.spans.append(curSpan)
    ...
    def defineCommentPattern(self):
        ...
        self._commentPattern = QRegExp(pattern)
    ...
    def defineKeywordPattern(self):
        ...
        self._keywordPattern = QRegExp(pattern)
